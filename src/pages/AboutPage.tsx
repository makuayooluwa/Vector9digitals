    ...
    <div className="pt-28 md:pt-36 pb-24 md:pb-32 text-[#F5F5F2]">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20">
          <div className="lg:col-span-7 space-y-6 text-base text-[#888888] leading-relaxed">
          ...
          <div className="lg:col-span-5 bg-[#111111] p-8 rounded-2xl border border-[#222222] space-y-6">
            ...
            <div className="space-y-4 text-xs font-mono">
              ...
              <div className="flex justify-between pb-2 border-b border-[#181818]">
                ...
                <span className="text-white font-semibold">Shopify & E-Commerce</span>
              </div>
              <div className="flex justify-between pb-2 border-b border-[#181818]">
              ...
              <div className="flex justify-between pb-2 border-b border-[#181818]">
                ...
                <span className="text-white font-bold">57,679 Products Approved</span>
              </div>
        ...
        <div className="p-8 sm:p-12 rounded-2xl bg-[#111111] border border-[#222222] text-center max-w-3xl mx-auto space-y-6">

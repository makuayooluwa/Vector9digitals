      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="flex items-center gap-2 text-xs font-mono text-[#888888] tracking-widest uppercase">
              <span>AGENCY</span>
              <span>·</span>
              <span>ABOUT VECTOR9</span>
            </div>

            <h2 className="text-3xl md:text-5xl font-bold font-display uppercase tracking-tight text-[#FFFFFF] leading-tight">
              A SMALL TEAM. <br />
              A BIG DIGITAL OUTLOOK.
            </h2>

            <p className="text-base sm:text-lg text-[#FFFFFF] font-normal leading-relaxed">
            ...
            {navigate && (
              <div className="pt-4">
                <button
                  ...
                  className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-wider text-white hover:text-[#D4D4D4] transition-colors group"
                >
          ...
          <div className="lg:col-span-6 space-y-6 lg:pl-8">
            <div className="rounded-xl border border-[#202020] bg-[#111111] p-8 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded bg-[#181818] border border-[#333333] flex items-center justify-center text-white shrink-0 mt-0.5">
              ...
              <div className="pt-4 border-t border-[#1C1C1C] flex items-center justify-between text-xs font-mono text-[#888888]">
                ...
                <span className="text-white">SHOPIFY & E-COMMERCE FIRST</span>
              </div>
            </div>
          </div>

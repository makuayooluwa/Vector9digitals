      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 lg:gap-6">
          {APPROACH_STEPS.map((step, idx) => (
            <div
              key={step.number}
              className="group rounded-xl border border-[#1E1E1E] bg-[#111111] p-6 hover:border-[#444444] transition-all duration-300 relative flex flex-col justify-between"
            >
              {/* Top Accent Line */}
              <div className="w-8 h-0.5 bg-[#262626] group-hover:bg-white transition-colors mb-6" />
